...
@Component({
  selector: 'app-auth-plan-dto-card',
  imports: [
    NzButtonComponent,
    NzCardComponent,
  ...
  templateUrl: './auth-plan-dto-card.html',
  styleUrl: './auth-plan-dto-card.css',
})
export class AuthPlanDtoCard {
  plan = input.required<AuthPlanDto>();
