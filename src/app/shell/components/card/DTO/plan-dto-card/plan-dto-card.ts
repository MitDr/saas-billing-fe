...
import {PlanDTO} from '../../../../../core/interface/DTO/planDTO';
...
@Component({
  ...
  templateUrl: './plan-dto-card.html',
  styleUrl: './plan-dto-card.css',
})
export class PlanDtoCard {
